...
namespace StudentManagement.Controllers
{
    public class FacultyController : Controller
    {
        ...
        public FacultyController(IStudentRepository studentRepo, ICourseRepository courseRepo)
        {
        ...
        private void SetStrategy(Role role)
        {
            ...
            {
                Role.Faculty => new FacultyStrategy(),
                _ => throw new ArgumentException("Invalid role for Faculty.")
            };
        }
        ...
        {
            if (HttpContext.Session.GetString("Role") != Role.Faculty.ToString())
                return Unauthorized();
